    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          ...
          <section 
            className="relative h-[80vh] flex items-center justify-center text-center text-white water hero-with-overlay"
            style={{ backgroundImage: `url(${hero.image})` }}
          >
            {/* Content */}
            <div className="relative z-10 px-4">
              <h1 className="text-5xl font-bold mb-4">
                <TextFadeIn>{hero.title}</TextFadeIn>
              </h1>
              <p className="text-lg max-w-2xl mx-auto">
                <TextReveal duration={1} delay={0}>{hero.subtitle}</TextReveal>
              </p>
            </div>
          </section>
          ...
          <section className="dark:bg-dark-panel py-20 bg-gray-50">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center px-6">
              ...
              />
              <div>
                <h2 className="dark:text-white text-3xl font-bold mb-6">
                  <TextFadeIn>{aboutIntro.title}</TextFadeIn>
                </h2>
            ...
            <div className="dark:bg-black max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center px-6">
              <div className="order-2 md:order-1">
                <h2 className="text-3xl font-bold mb-6">
                  <TextFadeIn>{journey.title}</TextFadeIn>
                </h2>
                <p className="dark:text-dark-muted text-lg text-gray-700 leading-relaxed">
