...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8 sm:py-12 mt-10 border-t border-gray-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm sm:text-base leading-relaxed max-w-md mx-auto md:mx-0">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <li>
                <a href="/" className="hover:text-white transition-colors duration-200 block sm:inline">
                  Home
                </a>
              </li>
              <li>
                <a href="/events" className="hover:text-white transition-colors duration-200 block sm:inline">
                  Events
                </a>
              </li>
              <li>
                <a href="/about" className="hover:text-white transition-colors duration-200 block sm:inline">
                  About Us
                </a>
              </li>
              <li>
                <a href="/contact" className="hover:text-white transition-colors duration-200 block sm:inline">
                  Contact
                </a>
              </li>
            </ul>
        ...
        {/* Copyright */}
        <div className="text-center text-xs sm:text-sm text-gray-500 mt-8 sm:mt-12 border-t border-gray-700 pt-4 sm:pt-6">
